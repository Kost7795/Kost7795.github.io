...
function compareRate_2() {
  ...
  if (sum_slider_3 > sum_slider_4 || sum_slider_3 < sum_slider_4) {
    ...
    drob_result_2_1.innerHTML = text1 + " — " + sum_slider_3 + '/70';
    drob_result_2_2.innerHTML = text2 + " — " + sum_slider_4 + '/70';
...
function compareRate_3() {
  ...
  if (sum_slider_5 > sum_slider_6 || sum_slider_5 < sum_slider_6) {
    ...
    drob_result_3_1.innerHTML = text1 + " — " + sum_slider_5 + '/70';
    drob_result_3_2.innerHTML = text2 + " — " + sum_slider_6 + '/70';
    result_proc_3.innerHTML = "Данный сервис лучше отвечает <br> требованиям на " + result_value_3.toFixed(2) + "%";
    btn_reset.classList.add("btn_reset_active");
...
function reset_3() {
  ...
  btn_reset.classList.remove("btn_reset_active");
}